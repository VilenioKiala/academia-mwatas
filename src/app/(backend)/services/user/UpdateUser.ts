...
class UpdateUserService implements UpdateUserUsecase {
  ...
  async deleteOldProfilePic(oldProfilePic: string) {
    if (oldProfilePic) {
      await unlink(
        path.resolve(
          __dirname,
  ...
  async saveNewProfilePic(newProfilePic: File, oldProfilePic: string) {
    ...
    await this.deleteOldProfilePic(oldProfilePic);
  ...
  async update(params: UpdateUserUsecaseParams) {
    ...
    if (params.profilePic == "") {
      await this.deleteOldProfilePic(oldProfilePic as string);
