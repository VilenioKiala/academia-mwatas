...
type AdicionarElementoBannerFormProps = {
  cursos: ICourse[];
};

export default function AdicionarElementoBannerForm({
  cursos,
}: AdicionarElementoBannerFormProps) {
  ...
  return (
    <div className="h-full my-10">
      <>
        <H1 className="">Adicionar Elemento ao banner</H1>
        ...
        <form method="post" onSubmit={handleSubmit}>
          <div className="flex-1 grid grid-cols-2 items-center gap-8">
            ...
            >
              ...
              <p className="text-danger mt-2">{photo.error && photo.error}</p>
            </div>
              ...
              <Tabs value={activeTab}>
                ...
                >
                  <Tab
                    ...
                    className={activeTab === "curso" ? "text-gray-900" : ""}
                    placeholder={undefined}
                    onPointerEnterCapture={undefined}
                    onPointerLeaveCapture={undefined}
                  >
                  ...
                  <Tab
                    ...
                    className={activeTab === "link" ? "text-gray-900" : ""}
                    placeholder={undefined}
                    onPointerEnterCapture={undefined}
                    onPointerLeaveCapture={undefined}
                  >
                  ...
                  {activeTab == "curso" && (
                    <div>
                      <label className="flex flex-col gap-1">
                        ...
                        <small className="text-danger">
                          {touched.cursoId && errors.cursoId && errors.cursoId}
                        </small>
                      </label>
                    </div>
                  )}
