...
type AddMembroModalProps = {
  children: React.ReactNode;
};

export default function AddMembroModal({ children }: AddMembroModalProps) {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { setErrors }) => {
      ...
      form.append("nome_usuario", values.nomeUsuario);
      form.append("email", values.email);
      form.append("senha", values.senha);
      form.append("repetir_senha", values.repetirSenha);
  ...
  return (
    <>
      <Dialog>
        ...
        <DialogOverlay>
          <DialogContent className="sm:max-w-4xl max-h-svh overflow-y-scroll">
            <DialogHeader>
                      ...
                      >
                        ...
                        >
                          ...
                          <p className="text-center">
                            Solte aqui ou clique para seleccionar a foto de
                            perfil
                          </p>
                        </div>
                      </section>
